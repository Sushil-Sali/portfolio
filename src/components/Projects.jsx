      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">
            Explore some of the dynamic web applications I have built, ranging
            from ERP/CRM systems to E-commerce solutions.
          </p>
        </div>
                  ...
                  {project.githubUrl ? (
                    <div className="flex gap-4 border-t border-slate-100 dark:border-slate-800 pt-4">
                      <a
                        ...
                        className="w-full flex items-center justify-center gap-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-semibold py-2.5 px-4 rounded-xl text-sm transition-all cursor-pointer"
                      >
                        <FaGithub size={16} />
                        GitHub
                      </a>
