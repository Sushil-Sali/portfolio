...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="absolute bottom-1/4 right-1/10 w-96 h-96 bg-purple-500/20 rounded-full blur-3xl dark:bg-purple-600/10 pointer-events-none animate-pulse-glow" style={{ animationDelay: '2s' }}></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-400 text-base sm:text-lg mb-8 max-w-xl leading-relaxed">
              ...
              Node.js, Express.js, MongoDB, React, and JavaScript. Specializing in RESTful API engineering, schema design, and server-side security.
            </p>
            ...
            <div className="flex gap-4 justify-center md:justify-start">
              <a
                href="https://github.com/sushilsali"
                target="_blank"
              ...
              <a
                href="https://linkedin.com/in/sushilsali"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:text-primary dark:hover:text-primary rounded-xl transition-all hover:scale-110 shadow-sm"
                aria-label="LinkedIn"
