...
const About = () => {
  const stats = [
    ...
    { label: "Main Stack", value: "Node.js / Express.js" },
    { label: "Core Projects", value: "ERP / CRM Apps" },
  ...
  const highlights = [
    ...
    },
    {
      icon: FaLock,
      title: "Security & Auth",
      desc: "Implementing state-of-the-art token security (JWT), bcrypt password hashing, and secure authentication flows.",
    },
    {
      icon: FaRocket,
      title: "Clean Coder",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">
            Get to know my backend journey, technical strengths, and core
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              I am a Backend Developer Intern with hands-on experience building
              scalable ERP/CRM systems, RESTful APIs, and secure authentication
              flows. My expertise lies in backend architecture, MongoDB schema
              design, JWT and OTP-based authentication, and real-world problem
              solving.
            </p>

            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              Through my internship at Talentrise Technokrate Pvt. Ltd., I
              contributed to the Softwave-Technify platform, working on live
              backend modules, role-based access control, file uploads, and
              validation systems for enterprise workflows.
            </p>
